...
3 Sept
: Point Set Topology, Asymptotics [[notes]({{ site.baseurl }}/assets/pdfs/09-03_notes.pdf)]
  : CLRS Ch. 3
: **HW 0 due**{: .label .label-red }

8 Sept
: Analyzing Algorithms [[H0-1]({{ site.baseurl }}/assets/pdfs/HO-01_algo-analysis.pdf)] [[notes]({{ site.baseurl }}/assets/pdfs/09-08_board.pdf)]
